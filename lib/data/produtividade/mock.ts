...
const GERENTES = [
  "Flávio (PAP)",
  "Rose (Varejo)",
  "Paulo Cesar (Retenção)",
  "Suiane (Online)",
  "Gicélio (B2B)",
];
const NICHOS = [
  "PAP Região Fortaleza",
  "PAP Região Sergipe",
  "NGC Maceió",
  "NGC João Pessoa",
  "PAP Região Piauí",
  ...
  return [
    {
      ...
      delta: 5.1,
      available: true,
      helper: "Banda Larga (INTERNET + FWA)",
    },
    {
      ...
      delta: 3.4,
      available: true,
      helper: `Efetivados x Criados: ${ratio(efe, cri)}%`.replace(".", ","),
    },
    {
      ...
      delta: -1.2,
      available: true,
      helper: `Instalados x Efetivados: ${ratio(ins, efe)}%`.replace(".", ","),
    },
    {
