...
const CINCO_G: IndicatorDef[] = [
  ...
  },
  {
    ...
    polarity: "up",
    available: true,
    compute: { kind: "sum", field: "portab_concluida" },
    related: [
      {
        id: "portab_pendente",
        label: "Pendentes",
        unit: "qtd",
        polarity: "down",
        compute: { kind: "sum", field: "portab_pendente" },
      },
      {
        id: "portab_solicitada",
        label: "Solicitadas",
        unit: "qtd",
        polarity: "up",
        compute: { kind: "sum", field: "portab_solicitada" },
      },
    ],
    description:
      "Portabilidades 5G concluídas no mês (STATUS PORTADO, contagem distinta de pedidos). Fonte: portabilidade.",
  },
  {
    id: "VE33",
    block: "5g",
    ...
    compute: { kind: "sum", field: "portab_pendente" },
    description:
      "Portabilidades 5G solicitadas sem concluir a portagem (contagem distinta de pedidos). Menor é melhor. Fonte: portabilidade.",
  },
  {
    id: "VE34",
    block: "5g",
    ...
    polarity: "up",
    available: true,
    compute: { kind: "ratio", num: "portab_concluida", den: "ativacao_oficial" },
    chartExtras: [
      { label: "Concluídas", compute: { kind: "sum", field: "portab_concluida" }, unit: "qtd" },
      { label: "Ativações 5G", compute: { kind: "sum", field: "ativacao_oficial" }, unit: "qtd" },
    ],
    description:
      "Portabilidades concluídas ÷ ativações 5G (VE04, consolidado_5g_pedido) × 100. Fonte: portabilidade.",
  },
  {
    id: "VE35",
    block: "5g",
    ...
    polarity: "up",
    available: true,
    compute: { kind: "ratio", num: "portab_concluida", den: "portab_solicitada" },
    chartExtras: [
      { label: "Concluídas", compute: { kind: "sum", field: "portab_concluida" }, unit: "qtd" },
      { label: "Solicitadas", compute: { kind: "sum", field: "portab_solicitada" }, unit: "qtd" },
    ],
    description:
